---
title: Client Inventory Management Portal
# TODO: resume doesn't name the client — inferred as Czarnowski from the
# matching tech stack (Thymeleaf/Java/Spring, same as the other Czarnowski
# entries); confirm this is right
client: Czarnowski
